...
class Metaclass_ObjectList(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('autonav_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'autonav_interfaces.msg.ObjectList')
            logger.debug(
            ...
            from autonav_interfaces.msg import Object
...
class ObjectList(metaclass=Metaclass_ObjectList):
    ...
    _fields_and_field_types = {
        'objects': 'sequence<autonav_interfaces/Object>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['autonav_interfaces', 'msg'], 'Object')),  # noqa: E501
    )
